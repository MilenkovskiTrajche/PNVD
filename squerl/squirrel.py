...
# изменета е ширината на прозорот на играта
...
# изменета е големината на камерата
# додадени се нови променливи посебни за координатите, место една заедничка
CAMERASLACK_X = 120
CAMERASLACK_Y = 120
...
# дефинирање на нова константа за големина на која играта се смета за изгубена
LOSTSIZE = 10

# додавање на нова променлива за поени
playerScore = 0
...
def runGame():
    ...
    while True:  # main game loop
        ...
        for sObj in squirrelObjs:
            ...
            # изменување на правецот според случајно избраната вредност
        ...
        # изменети се сите референци на претходната променлива со новите променливи за посебните координати
            ...
            for i in range(len(squirrelObjs) - 1, -1, -1):
                ...
                if "rect" in sqObj and playerObj["rect"].colliderect(sqObj["rect"]):
                    ...
                    if sqObj["width"] * sqObj["height"] <= playerObj["size"] ** 2:
                        ...
                        # зголемување на поените на играчот
                        playerScore += 1
                        ...
                        # големината на играчот се намалува кога ќе допре поголема верверичка
                        playerObj["size"] -= (
                            int((playerObj["size"] * playerObj["size"]) ** 0.2) + 1
                        )

                        # додаден е нов услов за завршување на играта
        ...
        # приказ на освоените поени на играчот
        scoreSurf = BASICFONT.render(f"Score: {playerScore}", True, WHITE)
...
def makeNewSquirrel(camerax, cameray):
    ...
    # додавање на нова информација за случајно избран правец на скокање
